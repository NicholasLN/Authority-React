        ...
        <>
            <Body middleColWidth='6'>
                ...
                <form className='tableForm' onSubmit={(e)=>e.preventDefault()}>
                    ...
                    <h6>This will serve as your ingame information (what others will see), <b>so don't make it anything personal!</b></h6>
                    <hr />
                    <table className='table table-striped table-responsive'>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input onChange={(e) => setPoliticianName(e.target.value)}
                                        type="text" 
                                        name="politicianName" 
                                        className="form-control" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <select defaultValue={selectedEcoPosition} className="form-control">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select defaultValue={selectedSocPosition} className="form-control">
